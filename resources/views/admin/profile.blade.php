                            ...
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact"
                                        role="tab" aria-controls="nav-contact" aria-selected="false">Change password</a>
                                </div>
                            </nav>
                            <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade active show" id="nav-profile" role="tabpanel"
                                    ...
                                    <form action="{{route('admin.profile.update')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="userid" class=" form-control-label">User
                                                    Id</label></div>
                                            <div class="col-12 col-md-9"><input type="text" id="userid" name="userid"
                                                    placeholder="Text" class="form-control" value="{{$user->userid}}"></div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="name" class=" form-control-label">Name
                                                </label></div>
                                            <div class="col-12 col-md-9"><input type="text" id="name" name="name"
                                                    placeholder="Text" class="form-control" value="{{$user->name}}"></div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="image" class=" form-control-label">Profile
                                                    Image</label></div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><textarea name="about" id="about" rows="5"
                                                    placeholder="Content..." class="form-control">{{$user->about}}</textarea></div>
                                        </div>
                                    ...
                                    <form action="{{route('admin.profile.password')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="old_password"
                                                    class=" form-control-label">Old Password
                                                </label></div>
                                            <div class="col-12 col-md-9"><input type="password" id="old_password"
                                                    name="old_password" placeholder="Password" class="form-control"></div>
                                        </div>
                                        <div class="row form-group">
